...
public abstract class MvpRecyclerListAdapter<M, P extends BasePresenter, VH extends BaseViewHolder<P>> extends MvpRecyclerAdapter<M, P, VH> {
    ...
    public void clearAndAdd(Collection<M> data) {
        models.clear();
        presenters.clear();
    ...
    private void addInternal(M item) {
        models.add(item);
        presenters.put(getModelId(item), getPresenter(item));
    }
